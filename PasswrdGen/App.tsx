...
const PasswordScheme = Yup.object().shape({
  passwordLength : Yup.number().min(4,'Should be minimum of 4').max(16,'Should be maximum of 16').required('Length is required')
})
...
export default function App() {
  ...
  function generatePassword(PassWordLength : number){
    ...
    if(digitChar) characterList+=digitChar;
    if(specialChar) characterList+=specialChar;
